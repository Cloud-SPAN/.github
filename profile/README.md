...
| [Metatranscriptomics](https://cloud-span.github.io/metatranscriptomics/)| This hands-on, online course teaches data analysis for metatranscriptomics projects. It is aimed at those with little or no experience of using high performance computing (HPC) for data analysis. The materials cover (1) navigating file directories and using the command line (2) logging into a remote cloud instance (3) using common commands and running analysis programs in the command line (4) what is metatranscriptomics? (5) following a metatranscriptomics analysis workflow. 
